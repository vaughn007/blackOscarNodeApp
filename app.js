...
//console.log(process.env.DATABASEURL); //test if varible work

// var url = process.env.DATABASEURL || "mongodb://localhost:27017/yalpCamp"; //back url to DB
// mongoose.connect(url);
//mongoose.connect(process.env.DATABASEURL); //connect to database with variable
//mongoose.connect("mongodb://localhost:27017/yalpCamp", { useNewUrlParser: true });
